...
define('SECRET_SALT','f91vhSh75M3icu5h0PylnghvwIn4RB0t');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','ti.gv@ufjf.edu.br');

# Database Options
# ---------------------------------------------------
# Mysql Login info
define('DBTYPE','mysql');
define('DBHOST','10.10.10.7');
define('DBNAME','osticket');
define('DBUSER','os_user');
define('DBPASS','a2mendelev2a');
